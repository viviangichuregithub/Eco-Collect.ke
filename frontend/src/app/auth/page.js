                  ...
                  <Form className="space-y-4">
                    {!isLogin && (
                      <div>
                        ...
                        <Field type="text" name="fullName" className="w-full p-2 bg-[#C8D8B4] rounded" />
                    ...
                    <div>
                      ...
                      <Field type="email" name="email" className="w-full p-2 bg-[#C8D8B4] rounded" />
                    ...
                    <div className="relative">
                      ...
                      <Field
                        ...
                        name="password"
                        className="w-full p-2 bg-[#C8D8B4] pr-10 rounded"
                      />
                      <div
                    ...
                    <button
                      ...
                      className="mx-auto block bg-[#355E62] text-white px-10 rounded-full hover:bg-[#2c4b4f] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
